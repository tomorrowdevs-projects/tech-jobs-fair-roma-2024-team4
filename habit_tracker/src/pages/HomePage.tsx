							...
							<Card key={habit.id}>
								<CardContent>
									...
									<Typography color="text.secondary">
										{habit.isAllDay
											? "Tutto il giorno"
											: `Dalle ${habit.startTime || "N/A"} alle ${
													habit.endTime || "N/A"
											  }`}
									</Typography>
									<Typography color="text.secondary">
										{`Ricorrenza: ${
											habit.recurrence ? habit.recurrence : "Nessuna"
										}`}
									</Typography>
									{/* <Typography color="text.secondary">
									...
									<Typography color="text.secondary">
										{`Data di fine: ${
											habit.endDate ? habit.endDate.toLocaleDateString() : "N/A"
										}`}
									</Typography>
									<Typography color="text.secondary">
									...
									<Typography color="text.secondary">
										{`Date di completamento: ${habit.completionDates
